...
<div class="footer-wrap">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="info phone-1"><img loading="lazy" src="images/phone.png" alt=""> <a href="tel:917228011811"
                        ...
                        7228011811 </a><span class="info phone-1" style="color: #fff;"> /12/13/14/15 </span>
                </div>
        ...
        <div class="copyright">Copyright(c) 2020 Gujarat Apollo Industries Limited (ISO 9001:2015). All Rights
            Reserved.
        </div>
    </div>
</div>
...
<style>
  .whatsapp-floating {
      ...
      border-radius: 50px; /* Isko round-rectangle banaya taaki text fit ho sake */
      display: flex;
      align-items: center;
      justify-content: center;
      padding: 10px 20px; /* Text ke liye side me padding */
      ...
      /* Vibrate/Wobble Animation rules */
  ...
  .whatsapp-floating:hover {
      ...
      animation-play-state: paused; /* Hover karne par vibration ruk jayegi */
  }

  /* Icon ka size thoda bada kiya */
  .whatsapp-icon {
      width: 32px;
      height: 32px;
      margin-right: 10px; /* Icon aur text ke beech gap */
      fill: #FFFFFF; /* Icon ka color white karne ke liye */
  }

  /* Vibrate (Wobble) Animation Logic */
...
<a href="https://wa.me/917228011815?text=Hi%20Marketing%20Team%21%20I%20visited%20your%20website%20and%20want%20to%20know%20more%20about%20your%20services." class="whatsapp-floating" target="_blank" rel="noopener noreferrer">
