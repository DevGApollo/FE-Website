...
<section class="main-slider" attr="here 12345">
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <!-- Controls -->
        <a class="left carousel-control cstm-black-color" href="#carousel-example-generic" role="button"
           data-slide="prev">
            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="right carousel-control cstm-black-color" href="#carousel-example-generic" role="button"
           data-slide="next">
                    ...
                    <div class="ce-textpic ce-right ce-intext gujart-apollo-resp">
                        <div class="ce-bodytext ce-bodytext-cstm-one">
                            ...
                            <p>Welcome to India’s well respected manufacturer of high quality crushing and screening
                                equipment. Gujarat Apollo Industries Ltd. hails from Mehsana district of Gujarat and
                                is the flagship company of Apollo group of Industries. Established around 50 years
                                ago, Apollo group has catered the Earthmoving industry in India and abroad with its
                                high quality products and world class after sales services. Our track record is a
                                true testimony to our slogan:- Your dependable partner </p>
                            <p class="bg-btn1"><a href="about-us.php" title="" class="internal-link">read more</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div id="c144">
                    <div class="ce-textpic ce-right ce-intext gujart-apollo-resp">
                        <div class="ce-bodytext ce-bodytext-cstm-one">
                            ...
                            <h4>Gujarat Apollo Industries Limited</h4>
                            <p>Welcome to India's premier manufacturer of wide range of world class equipments to
                                serve Construction & Mining Industry. Apollo Equipment India, as is popularly known,
                                is a Conglomerate of Companies specialising in different product lines for
                                construction & mining industry for over four decades. With the equipment technology
                                is refined through over forty years of experience as part of company's continuous
                                product improvement focus, large manufacturing facilities; Apollo Equipment India is
                                the largest and most trusted manufacturer of Construction & Mining Industry
                                Equipment in India comparable to some of the world 's leading manufacturers.</p>
                            <p class="bg-btn1"><a href="about-us.php" title="" class="internal-link">read more</a>
                            </p>
                ...
                <div id="c144" class="service_mob_res_btm" style="margin: 20px 0px;">
                    <div class="ce-textpic ce-right ce-intext gujart-apollo-resp">
                        <div class="ce-bodytext ce-bodytext-cstm-one cstm-service-spares">
                            ...
                            <h4>SERVICE & SPARES
                                MANAGEMENT </h4>
                            <p>Gujarat Apollo has a rich heritage of delighting customers with world class parts and
                                service background. We have
                                performed by remaining present in all phases of product life cycle and achieving
                                optimum life cycle cost. This is evident by significant repeat business over the
                                years. Product design follows 3Es Philosophy (Environment, Energy, Efficiency). </p>
                            <p class="bg-btn1"><a href="service.php" title="" class="internal-link">read more</a>
                            </p>
                        </div>
                    </div>
                </div>
