                                    ...
                                    <div class="contact-box-content-2">
                                        ...
                                        <div class="contact-row">
                                            ...
                                            <div class="contact-row-text"><a href="mailto:info@apollo.co.in"
                                                                             ...
                                                                             style="color: #000;">info@apollo.co.in</a>
                                            </div>
                                        </div>
                                        <div class="contact-row">
                                            <div class="contact-row-icon fa fa-phone"></div>
                                ...
                                <div class="contact-box">
                                    ...
                                    <div class="contact-box-content-2">
                                        ...
                                        <div class="text-left cstm-a width-full">
                                            <a href="javascript:;" class=" btn-cstm click1 text-center">&nbsp;
                                                Careers </a>
                                            <a href="javascript:;" class="  click1 btn-cstm  text-center">&nbsp;
                                                Investor
                                                Relations
                                            </a>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="contact-address1">
                            <div class="contact-box">
                                ...
                                <form class="form-horizontal form3 my-custom-modal" action="quick_action.php"
                                      method="post">
